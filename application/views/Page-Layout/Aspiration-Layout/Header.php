...
<head>
    ...
    <!-- Icon Browser -->
    <link rel="icon" href="<?= base_url() ?>assets/Icon/building.png">
</head>

<body style="background-image: url(<?= base_url() ?>assets/Pattern/email-pattern.webp);" class="hold-transition register-page">