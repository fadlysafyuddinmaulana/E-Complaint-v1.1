    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">
                    <!-- Session View User -->
                    <?php
                    $user = $this->session->userdata('server_session');
                    $id_admin = $user['id_admin'];

                    $query = "select * from tb_admin where role = $id_admin";
                    $name = $this->db->query($query)->row_array();
                    ?>
                    <?= $name['nama_petugas']; ?>
                </a>
            </div>
        ...
        <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="pages/gallery.html" class="nav-link">
                        <i class="nav-icon fa-sharp fa-regular fa-building"></i>
                        <p>
                            Kelas
                        </p>
                    </a>
